...
class TestPaginatedGebiedenbuurtenList(unittest.TestCase):
    """PaginatedGebiedenbuurtenList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedGebiedenbuurtenList:
        """Test PaginatedGebiedenbuurtenList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedGebiedenbuurtenList`
        """
        model = PaginatedGebiedenbuurtenList()
        if include_optional:
            return PaginatedGebiedenbuurtenList(
                ...
                embedded = gebieden_api_client.models.paginated_gebiedenbuurten_list__embedded.PaginatedGebiedenbuurtenList__embedded(
                    buurten = [
    ...
    def testPaginatedGebiedenbuurtenList(self):
        """Test PaginatedGebiedenbuurtenList"""
