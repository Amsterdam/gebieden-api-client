...
class TestPaginatedGebiedenwijkenList(unittest.TestCase):
    """PaginatedGebiedenwijkenList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedGebiedenwijkenList:
        """Test PaginatedGebiedenwijkenList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedGebiedenwijkenList`
        """
        model = PaginatedGebiedenwijkenList()
        if include_optional:
            return PaginatedGebiedenwijkenList(
                ...
                embedded = gebieden_api_client.models.paginated_gebiedenwijken_list__embedded.PaginatedGebiedenwijkenList__embedded(
                    wijken = [
    ...
    def testPaginatedGebiedenwijkenList(self):
        """Test PaginatedGebiedenwijkenList"""
