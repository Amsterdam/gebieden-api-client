...
class TestPaginatedGebiedenggpgebiedenList(unittest.TestCase):
    """PaginatedGebiedenggpgebiedenList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedGebiedenggpgebiedenList:
        """Test PaginatedGebiedenggpgebiedenList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedGebiedenggpgebiedenList`
        """
        model = PaginatedGebiedenggpgebiedenList()
        if include_optional:
            return PaginatedGebiedenggpgebiedenList(
                ...
                embedded = gebieden_api_client.models.paginated_gebiedenggpgebieden_list__embedded.PaginatedGebiedenggpgebiedenList__embedded(
                    ggpgebieden = [
    ...
    def testPaginatedGebiedenggpgebiedenList(self):
        """Test PaginatedGebiedenggpgebiedenList"""
