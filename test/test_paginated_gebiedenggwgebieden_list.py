...
class TestPaginatedGebiedenggwgebiedenList(unittest.TestCase):
    """PaginatedGebiedenggwgebiedenList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedGebiedenggwgebiedenList:
        """Test PaginatedGebiedenggwgebiedenList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedGebiedenggwgebiedenList`
        """
        model = PaginatedGebiedenggwgebiedenList()
        if include_optional:
            return PaginatedGebiedenggwgebiedenList(
                ...
                embedded = gebieden_api_client.models.paginated_gebiedenggwgebieden_list__embedded.PaginatedGebiedenggwgebiedenList__embedded(
                    ggwgebieden = [
    ...
    def testPaginatedGebiedenggwgebiedenList(self):
        """Test PaginatedGebiedenggwgebiedenList"""
