# gebieden_api_client.GgpgebiedenApi
 ...
 **bestaat_uit_buurten_identificatie** | **str**| Exact; text | [optional] 
 **bestaat_uit_buurten_identificatie_in** | [**List[str]**](str.md)| Matches any value from a comma-separated list: val1,val2,valN. | [optional] 
 **bestaat_uit_buurten_identificatie_isempty** | **bool**| Whether the field is empty or not. | [optional] 
 **bestaat_uit_buurten_identificatie_isnull** | **bool**| Whether the field has a NULL value or not. | [optional] 
 **bestaat_uit_buurten_identificatie_like** | **str**| Matches text using wildcards (? and *). | [optional] 
 **bestaat_uit_buurten_identificatie_not** | [**List[str]**](str.md)| Exclude matches; text | [optional] 
 **bestaat_uit_buurten_volgnummer** | **int**| Exact; number | [optional] 
 **bestaat_uit_buurten_volgnummer_gt** | **int**| Greater than; number | [optional] 
 **bestaat_uit_buurten_volgnummer_gte** | **int**| Greater than or equal to; number | [optional] 
 **bestaat_uit_buurten_volgnummer_in** | [**List[int]**](int.md)| Matches any value from a comma-separated list: val1,val2,valN. | [optional] 
 **bestaat_uit_buurten_volgnummer_isnull** | **bool**| Whether the field has a NULL value or not. | [optional] 
 **bestaat_uit_buurten_volgnummer_lt** | **int**| Less than; number | [optional] 
 **bestaat_uit_buurten_volgnummer_lte** | **int**| Less than or equal to; number | [optional] 
 **bestaat_uit_buurten_volgnummer_not** | [**List[int]**](int.md)| Exclude matches; number | [optional] 
