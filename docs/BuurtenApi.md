# gebieden_api_client.BuurtenApi
...
async with gebieden_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling BuurtenApi->gebieden_buurten_list: %s\n" % e)
```
 ...
 **cbs_code_in** | [**List[str]**](str.md)| Matches any value from a comma-separated list: val1,val2,valN. | [optional] 
 **cbs_code_isempty** | **bool**| Whether the field is empty or not. | [optional] 
 **cbs_code_isnull** | **bool**| Whether the field has a NULL value or not. | [optional] 
 **cbs_code_like** | **str**| Matches text using wildcards (? and *). | [optional] 
 **cbs_code_not** | [**List[str]**](str.md)| Exclude matches; text | [optional] 
...
async with gebieden_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling BuurtenApi->gebieden_buurten_retrieve: %s\n" % e)
```
