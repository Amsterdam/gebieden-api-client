...
class GebiedenWijkenLinks(BaseModel):
    """
    ...
    var_self: GebiedenWijkenLink = Field(alias="self")
    ...
    __properties: ClassVar[List[str]] = ["schema", "self", "ligtInStadsdeel", "ligtInGgwgebied"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": GebiedenWijkenLink.from_dict(obj["self"]) if obj.get("self") is not None else None,
