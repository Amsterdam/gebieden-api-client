...
class Gebiedenggpgebieden(BaseModel):
    """
    ggpgebieden
    """ # noqa: E501
    links: GebiedenGgpgebiedenLinks = Field(alias="_links")
    ...
    ligt_in_stadsdeel_id: Optional[StrictStr] = Field(description="Het stadsdeel waar het ggpgebied in ligt", alias="ligtInStadsdeelId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": GebiedenGgpgebiedenLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
