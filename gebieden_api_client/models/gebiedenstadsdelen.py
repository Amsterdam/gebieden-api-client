...
class Gebiedenstadsdelen(BaseModel):
    """
    ...
    """ # noqa: E501
    links: GebiedenStadsdelenLinks = Field(alias="_links")
    ...
    begin_geldigheid: Optional[datetime] = Field(default=None, description="De ingangsdatum van de geldigheid van een bepaalde combinatie van gegevens over een stadsdeel", alias="beginGeldigheid")
    eind_geldigheid: Optional[datetime] = Field(default=None, description="De einddatum van de geldigheid van een bepaalde combinatie van gegevens over een stadsdeel", alias="eindGeldigheid")
    ...
    ligt_in_gemeente_id: Optional[StrictStr] = Field(description="De gemeente waar het stadsdeel in ligt", alias="ligtInGemeenteId")
    geometrie: Optional[Polygon] = None
    __properties: ClassVar[List[str]] = ["_links", "identificatie", "volgnummer", "registratiedatum", "naam", "code", "beginGeldigheid", "eindGeldigheid", "documentdatum", "documentnummer", "ligtInGemeenteId", "geometrie"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if ligt_in_gemeente_id (nullable) is None
        # and model_fields_set contains the field
        if self.ligt_in_gemeente_id is None and "ligt_in_gemeente_id" in self.model_fields_set:
            _dict['ligtInGemeenteId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": GebiedenStadsdelenLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            ...
            "ligtInGemeenteId": obj.get("ligtInGemeenteId"),
