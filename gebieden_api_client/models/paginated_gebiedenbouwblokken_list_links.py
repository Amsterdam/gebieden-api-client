...
class PaginatedGebiedenbouwblokkenListLinks(BaseModel):
    """
    PaginatedGebiedenbouwblokkenListLinks
    """ # noqa: E501
    var_self: Optional[PaginatedGebiedenbouwblokkenListLinksSelf] = Field(default=None, alias="self")
    next: Optional[PaginatedGebiedenbouwblokkenListLinksNext] = None
    previous: Optional[PaginatedGebiedenbouwblokkenListLinksPrevious] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": PaginatedGebiedenbouwblokkenListLinksSelf.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "next": PaginatedGebiedenbouwblokkenListLinksNext.from_dict(obj["next"]) if obj.get("next") is not None else None,
            "previous": PaginatedGebiedenbouwblokkenListLinksPrevious.from_dict(obj["previous"]) if obj.get("previous") is not None else None
        })
        return _obj
