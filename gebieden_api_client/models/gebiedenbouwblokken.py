...
class Gebiedenbouwblokken(BaseModel):
    """
    ...
    """ # noqa: E501
    links: GebiedenBouwblokkenLinks = Field(alias="_links")
    ...
    begin_geldigheid: Optional[datetime] = Field(default=None, description="De ingangsdatum van de geldigheid van een bepaalde combinatie van gegevens over een bouwblok", alias="beginGeldigheid")
    eind_geldigheid: Optional[datetime] = Field(default=None, description="De einddatum van de geldigheid van een bepaalde combinatie van gegevens over een bouwblok", alias="eindGeldigheid")
    ligt_in_buurt_id: Optional[StrictStr] = Field(description="De buurt waar het bouwblok in ligt", alias="ligtInBuurtId")
    geometrie: Optional[Polygon] = None
    __properties: ClassVar[List[str]] = ["_links", "identificatie", "volgnummer", "registratiedatum", "code", "beginGeldigheid", "eindGeldigheid", "ligtInBuurtId", "geometrie"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if ligt_in_buurt_id (nullable) is None
        # and model_fields_set contains the field
        if self.ligt_in_buurt_id is None and "ligt_in_buurt_id" in self.model_fields_set:
            _dict['ligtInBuurtId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": GebiedenBouwblokkenLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            ...
            "ligtInBuurtId": obj.get("ligtInBuurtId"),
