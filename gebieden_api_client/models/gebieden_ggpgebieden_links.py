...
class GebiedenGgpgebiedenLinks(BaseModel):
    """
    ...
    var_self: GebiedenGgpgebiedenLink = Field(alias="self")
    ligt_in_stadsdeel: GebiedenStadsdelenLink = Field(alias="ligtInStadsdeel")
    bestaat_uit_buurten: List[GebiedenggpgebiedenBestaatUitBuurtenM2M] = Field(alias="bestaatUitBuurten")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": GebiedenGgpgebiedenLink.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "ligtInStadsdeel": GebiedenStadsdelenLink.from_dict(obj["ligtInStadsdeel"]) if obj.get("ligtInStadsdeel") is not None else None,
            "bestaatUitBuurten": [GebiedenggpgebiedenBestaatUitBuurtenM2M.from_dict(_item) for _item in obj["bestaatUitBuurten"]] if obj.get("bestaatUitBuurten") is not None else None
        })
        return _obj
